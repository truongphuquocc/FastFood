...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link" href="AdminController">
					<i class="fas fa-fw fa-chart-area"></i> <span>Danh sách
						chuyển tiền</span>
			</a></li>

			<li class="nav-item active"><a class="nav-link" href="Adm">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="ml-auto mr-auto mt-3 rounded"
								...
								<form action="AdminSuaLoaiConTroller" method="post"
									enctype="multipart/form-data">
									<div class="form-group">
										<label for="inputPassword4">Mã Loại</label> <input type="text"
											readonly="readonly" placeholder="Username"
											value="${lbean.getMaLoai()}" name="txtmaloai" id="username"
											class="form-control" value="" />
									</div>
									<div class="form-group">
										<label for="inputPassword4">Tên Loại</label> <input
											type="text" value="${lbean.getTenLoai()}"
											placeholder="password" name="txttenloai" id="password"
											class="form-control" />
									</div>
									<div class="form-row">
