...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link" href="AdminXacNhanController">
					<i class="fas fa-fw fa-chart-area"></i> <span>Xác nhận</span>
			</a></li>

			<li class="nav-item"><a class="nav-link"
				href="AdminController"> <i
					class="fas fa-fw fa-chart-area"></i> <span>Danh sách chuyển
						tiền</span></a></li>

			<li class="nav-item active"><a class="nav-link"
				href="Adm"> <i class="fas fa-fw fa-chart-area"></i>
					<span>Quản lý loại</span></a></li>

			<li class="nav-item"><a class="nav-link"
				href="AdminQuanLyKhachHangController"> <i class="fas fa-fw fa-chart-area"></i>
					<span>Quản lý khách hàng</span></a></li>

			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="AdminQuanLyMonController">
					<i class="fas fa-fw fa-table"></i> <span>Quản lý món ăn</span>
			</a></li>
			<!-- Divider -->
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Thêm loại</h1>
							...
							<div class="ml-auto mr-auto mt-3 rounded"
								...
								<form action="AdminThemLoaiController" method="post"
									...
									<div class="form-group">
										<label for="inputPassword4">Mã loại</label> <input type="text"
											placeholder="Mã loại" name="txtmaloai" id="username"
											class="form-control" />
									</div>
									<div class="form-group">
										<label for="inputPassword4">Tên loại</label> <input
											type="text" placeholder="tên loại" name="txttenloai"
											id="password" class="form-control" />
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="inputPassword4">Ảnh</label> <input type="file"
												required name="txtanh" accept="image/png, image/jpeg"
									...
									<a href="AdminQuanLyLoaiController?btnBack=${1}"
										class="btn btn-primary"> <i
										class="fa-solid fa-circle-left"></i> Quay lại
									</a>
								</form>
							</div>
							<!-- End add product -->
