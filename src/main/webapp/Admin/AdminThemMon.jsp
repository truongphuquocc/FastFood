					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="ml-auto mr-auto mt-3 rounded"
								...
								<form action="AdminThemMonController" method="post"
									enctype="multipart/form-data">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="inputEmail4">Mã món</label> <input type="text"
												required name="txtmamon" name="" class="form-control"
												id="inputEmail4" />
										</div>
										<div class="form-group col-md-6">
											<label for="inputPassword4">Tên món</label> <input
												name="txttenmon" required type="text" class="form-control"
												id="inputPassword4" />
										</div>
									</div>
									...
									<div class="form-row">
										<div class="form-group col-md-4">
											<label for="inputEmail4">Số lượng</label> <input type="text"
												required name="txtsoluong" name="" class="form-control"
												id="inputEmail4" />
										</div>

										<div class="form-group col-md-4">
											<label for="inputPassword4">Giá</label> <input type="text"
												required name="txtgia" name="" class="form-control"
												id="inputPassword4" />
										</div>

										<div class="form-group col-md-4">
											<label for="inputState">Mã loại</label> <select
									...
									$
									<c:out value="${sessionScope.trungma }"/>
