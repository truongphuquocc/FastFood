								...
								<div
									...
									<div class="swiper-wrapper" style="display: flex;">
										...
										<div class="swiper-slide swiper-slide-next"
											...
											<a class="txt current" title="Nhượng quyền"
												href="/account/history?tab=delivery_complete">Hoàn tất
												giao hàng <span>(<c:out value="${dslichsu.size() }"></c:out>)
											</span>
											</a>
										</div>
										...
										<div class="swiper-slide swiper-slide-next"
											...
											<a class="txt" title="Câu chuyện thương hiệu"
